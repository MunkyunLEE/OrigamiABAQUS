...
All details are included in reference [2]. 
...
(It will be my next step in the future)
If you would like to add additional features or modify aspects beyond the current codes, please refer to the Abaqus API documentation at the following site [5].
**!!! PLEASE READ !!!**
